...
var cachedTextEncoder = typeof TextEncoder !== 'undefined'
...
var cachedTextDecoder = typeof TextDecoder !== 'undefined'
...
function transformSync(s, opts, experimental_plugin_bytes_resolver) {
  try {
    ...
    wasm.transformSync(
      ...
      addHeapObject(s),
      addHeapObject(opts),
      addHeapObject(experimental_plugin_bytes_resolver),
    )
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === 'undefined') {
    module_or_path = new URL(
      'https://esm.sh/@swc/wasm-web@1.13.2/es2022/wasm_bg.wasm',
    )
  }
